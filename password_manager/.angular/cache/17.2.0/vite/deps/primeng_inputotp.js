...
function InputOtp_ng_container_0_ng_container_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("value", ctx_r2.getModelValue(i_r1))("maxLength", 1)("type", ctx_r2.inputType)("inputmode", ctx_r2.inputMode)("variant", ctx_r2.variant)("readonly", ctx_r2.readonly)("disabled", ctx_r2.disabled)("invalid", ctx_r2.invalid)("tabindex", ctx_r2.tabindex)("unstyled", ctx_r2.unstyled)("autofocus", ctx_r2.getAutofocus(i_r1));
  }
}
...
function InputOtp_ng_container_0_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r3.inputTemplate)("ngTemplateOutletContext", ɵɵpureFunction3(2, _c0, ctx_r3.getToken(i_r1 - 1), ctx_r3.getTemplateEvents(i_r1 - 1), i_r1));
  }
}
function InputOtp_ng_container_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r0.inputTemplate);
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r0.inputTemplate);
  }
}
